        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavouriteUserBooksId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserBook", x => new { x.FavouriteBooksId, x.FavouriteUserBooksId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserBook_AspNetUsers_FavouriteUserBooksId",
                        column: x => x.FavouriteUserBooksId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserBook_Books_FavouriteBooksId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserBook_FavouriteUserBooksId",
                table: "ApplicationUserBook",
                column: "FavouriteUserBooksId");
